...
//     try {
//         const response = await fetch('https://api.navitia.io/v1/coverage/fr-idf/lines?', {
...
//         data.lines.filter((item) => {
           
//             if(item.physical_modes.filter((metro) => metro.name === "Métro")) {
//                 if(Metro.includes(item.code)) {
//                     dataLines.push(item.code, item.id)
//                     // dataLines.push(item)
//                 }
//             }

//             if(item.physical_modes.filter((rer) => rer.name === "RER")) {
//                 if(RER.includes(item.code)) {
//                     dataLines.push(item.code, item.id)
//                     // dataLines.push(item)
//                 }
//             }

//             if(item.physical_modes.filter((tram) => tram.name === "Tramway")) {
//                 if(Tram.includes(item.code)) {
//                     dataLines.push(item.code, item.id)
//                     // dataLines.push(item)
//                 }
//             }
